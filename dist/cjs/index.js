...
function useInternalEditor(e) {
  ...
  invariant__default.default(
    n,
    utils.ERROR_USE_EDITOR_OUTSIDE_OF_EDITOR_CONTEXT
  );
...
function useInternalNode(e) {
  ...
  invariant__default.default(t, utils.ERROR_USE_NODE_OUTSIDE_OF_EDITOR_CONTEXT);
  var n = t.id,
    r = t.related,
...
var SimpleElement = function (e) {
  ...
  RenderNodeToElement = function (e) {
    ...
    return n
      ? null
      : React__default.default.createElement(r, {
          render:
            t || React__default.default.createElement(DefaultRender, null),
        });
  },
  NodeElement = function (e) {
    return React__default.default.createElement(
      NodeProvider,
      { id: e.id },
      React__default.default.createElement(RenderNodeToElement, {
        render: e.render,
      })
    );
  },
    ...
    utils.useEffectOnce(function () {
      ...
      if (l) {
        ...
        if (c && c.data.type === o) d = c.id;
          ...
          var f = React__default.default.createElement(Element$1, r, n),
            v = i.parseReactElement(f).toNodeTree();
          (d = v.rootNodeId), s.history.ignore().addLinkedNodeFromTree(v, e, t);
        }
        p(d);
      }
    }),
    f ? React__default.default.createElement(NodeElement, { id: f }) : null
  );
}
...
var RenderRootNode = function () {
  ...
  Frame = function (e) {
    ...
    return (
      ...
      React__default.default.createElement(RenderRootNode, null)
    );
  };
...
var resolveComponent = function (e, t) {
    ...
    return (
      invariant__default.default(
        r,
        utils.ERROR_NOT_IN_RESOLVER.replace('%node_type%', n)
      ),
      r
    );
  },
...
function findPosition(e, t, n, r) {
  for (
    ...
    var p = t[c];
    if (
      ((l = p.top + p.outerHeight),
      (d = p.left + p.outerWidth / 2),
      (u = p.top + p.outerHeight / 2),
      !((i && p.left > i) || (s && u >= s) || (a && p.left + p.outerWidth < a)))
    )
      if (((o.index = c), p.inFlow)) {
        if (r < u) {
          o.where = 'before';
          break;
        }
    ...
    Object.keys(a.related).forEach(function (e) {
      r.related[e] = function () {
        return React__default.default.createElement(
          NodeProvider,
          i,
          React__default.default.createElement(a.related[e])
        );
      };
    });
  }
    ...
    getDropPlaceholder: function (t, r, o, a) {
      ...
      if (s) {
        var d = s.data.nodes || [],
          ...
          l = d.length && e.nodes[d[u.index]],
          c = {
            placement: _assign(_assign({}, u), { currentNode: l }),
            error: null,
          };
        return (
  ...
  Events = function (e) {
    ...
    return r
      ? React__default.default.createElement(
          ...
          { value: r },
          React__default.default.createElement(RenderEditorIndicator, null),
          t
        )
      : null;
  },
